...
import Constatnt_url,{BASE_URL,LOGIN_USER} from "../../../../http/Constatnt_url";
...
const Login = (props) => {
    ...
    console.log("Constatnt_url",Constatnt_url);
...
const toggelPass = () =>{
    ...
    const login = async () => {
        // fetch(Constatnt_url.BASE_URL + Constatnt_url.LOGIN_USER, {
        //     body: {
        //         emailId: email,
        //         password: password
        //     },
            ...
            <ImageBackground
                ...
                <KeyboardAwareScrollView
                    ...
                    <View style={{ paddingTop: 20, paddingHorizontal: 15 }} >
                        ...
                        <Button button1 btn1  title={'Login'}
                            borderRadius={10}
                            // onPress={handleLogin}
                            // onPress={login}
