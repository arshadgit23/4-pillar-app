                ...
                <>
                    <View style={{
                        ...
                        <TouchableOpacity onPress={onPressbtn} style={{
                            ...
                            {props.btn ?
                                (
                                    <View style={{width:34, height:34, borderRadius: 50, backgroundColor: Colors.text.tertiary, justifyContent:"center", alignItems:"center" }}>
                                    <Fontisto name='locked' size={20} color='#1AC042'/>
                                    </View>
                                ) :
                                (<RadioButton
                                    value="Easy"
